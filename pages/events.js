		...
		<div>
			...
			<div className="max-w-7xl mx-auto">
				<div className="flex justify-start mt-16">
					<h1 className="font-serif text-7xl  text-gray-900">Events</h1>
				</div>
			</div>
			<div className="max-w-7xl mx-auto">
				<div>
					<div className="events-section w-full h-full">
						...
						<div className="flex flex-col md:flex-row md:justify-between mt-10  max-w-7xl mx-auto border-b md:border-b-0 border-gray-600 border-t border-gray-600 py-8">
							<div className="event-date text-md text-gray-900 flex flex-row justify-start items-center">
						...
						<div className="flex flex-col md:flex-row md:justify-between mt-10  max-w-7xl mx-auto border-b border-gray-600 border-t md:border-t-0 border-gray-600 py-8">
							<div className="event-date text-md text-gray-900 flex flex-row justify-start items-center">
								<span className="ml-10 font-serif font-bold">Fr</span>
								<span className="ml-10 font-serif font-bold">24.09</span>
				...
				<div className="w-full  h-full mb-16 mt-16 flex md:justify-between flex-col md:flex-row ">
					...
					<form className="my-form  font-sans text-gray-900 w-full max-w-md mx-auto mt-24 flex flex-col">
						...
						<div className="mt-5 border-none mb-5 flex justify-center">
							<input
								className="text-gray-900 py-3 px-2 w-56 border-b bg-transparent border-gray-500 focus:outline-none"
								placeholder="Name"
								type="text"
								required
							></input>
							<input
								className="bg-transparent py-3 px-2 w-56 border-b bg-gray-50 border-gray-500 ml-3 focus:outline-none"
								placeholder="Email"
								type="email"
								required
							></input>
