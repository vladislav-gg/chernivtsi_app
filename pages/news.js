                ...
                <h1 className='font-serif text-7xl font-medium '>News</h1>
                    <div className='flex flex-col md:flex-row w-full h-full mt-12'>
                        <div className='md:max-w-md'>
                            ...
                            <div className='left-col mt-1 left-col hover:shadow-lg transition duration-200 ease-in p-5'>
                                <a href='/shows/nutckracker'>
                    ...
                    <div className='flex flex-col md:flex-row-reverse w-full h-full mt-12'>
                        ...
                        <div className='right-col md:mr-10 h-full w-full mt-16 md:mt-0 hover:shadow-lg transition duration-200 ease-in p-5'>
                            <a href='/shows/nutckracker'>
                                <img src='/images/my_pic.jpg'></img>
                                <div className="flex flex-col pt-5"> 
                                    <p className="text-xl text-gray-500 mt-1">20 September 2021</p>
