			...
			<div>
				<div className="events-section w-full h-full">
					...
					<a href="/shows/nutckracker">
						<div className="event_container flex flex-col md:flex-row md:justify-between mt-10  max-w-7xl mx-auto border-b border-gray-600 border-t border-gray-600 py-8 text-gray-900 hover:text-gray-500 hover:transition duration-200">
