				...
				<div className="events-section w-full h-full">
					...
					<div className="flex flex-col md:flex-row md:justify-between mt-10  max-w-7xl mx-auto border-b border-gray-600 border-t border-gray-600 py-8">
						...
						<div className="flex md:items-center ml-10 mt-5 md:ml-0 md:mt-0">
							<button
								type="button"
								className="text-gray-900  px-10 py-2 border-2 border-gray-600 text-gray-900 hover:bg-gray-900 hover:text-gray-100 duration-700 text-base"
							>
								Buy tickets
							</button>
						</div>
					...
					<div className="flex flex-col md:flex-row md:justify-between mt-10  max-w-7xl mx-auto border-b border-gray-600 border-t border-gray-600 py-8">
						...
						<div className="flex md:items-center ml-10 mt-5 md:ml-0 md:mt-0">
							<button className="text-gray-900  px-10 py-2 border-2 border-gray-600 text-gray-900 hover:bg-gray-900 hover:text-gray-100 duration-700 text-base">
								Buy tickets
							</button>
						</div>
					</div>
