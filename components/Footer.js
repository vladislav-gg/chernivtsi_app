...
export default function Footer() {
    return (
        <div>
         <footer>
            <div className="w-full  h-full mb-16 mt-16 flex md:justify-between flex-col md:flex-row border-t" >
            ...
            <form className="my-form  font-sans text-gray-900 w-full max-w-md mx-auto mt-24 flex flex-col">
                ...
                <input className='text-gray-900 py-3 px-2 w-56 border-b  border-gray-500 focus:outline-none' placeholder='Name' type="text" required></input>
                <input className='text-gray-900 py-3 px-2 w-56 border-b  border-gray-500 ml-3 focus:outline-none' placeholder='Email' type="email" required></input>
                </div>
